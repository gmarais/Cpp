...
int		main()
{
	...
	*totocopy = toto;
	...
	std::cout << "--------TESTING SUPERTRAP--------" << std::endl;
	FragTrap	fragger("Fragger");
	ScavTrap	scavenger("Scavenger");
	SuperTrap	superrainbow("Super Rainbow");
	yuisenpai.ninjaShoebox(superrainbow);
	superrainbow.ninjaShoebox(yuisenpai);
	superrainbow.vaulthunter_dot_exe("tamamanlel");
	superrainbow.vaulthunter_dot_exe("tamamanlel");
	superrainbow.vaulthunter_dot_exe("tamamanlel");
	superrainbow.ninjaShoebox("tamamanlel");
	superrainbow.ninjaShoebox(fragger);
	superrainbow.ninjaShoebox(scavenger);
